...
class Ui_ThunderViewer(object):
    def setupUi(self, ThunderViewer):
        ...
        ThunderViewer.resize(500, 430)
        ThunderViewer.setMinimumSize(QtCore.QSize(500, 430))
        ThunderViewer.setMaximumSize(QtCore.QSize(500, 430))
        ...
        self.recording.setGeometry(QtCore.QRect(210, 350, 82, 17))
        self.recording.setObjectName("recording")
        self.record = QtWidgets.QPushButton(self.centralwidget)
        self.record.setGeometry(QtCore.QRect(40, 320, 201, 23))
        self.record.setObjectName("record")
        self.stop = QtWidgets.QPushButton(self.centralwidget)
        self.stop.setGeometry(QtCore.QRect(260, 320, 201, 23))
        ...
        self.launch_tacview_live.setGeometry(QtCore.QRect(40, 270, 421, 31))
        ...
        self.live_usb.setGeometry(QtCore.QRect(50, 230, 191, 20))
        self.live_usb.setObjectName("live_usb")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(40, 180, 201, 20))
        self.label_4.setObjectName("label_4")
        self.usb_ports = QtWidgets.QComboBox(self.centralwidget)
        self.usb_ports.setGeometry(QtCore.QRect(40, 200, 201, 22))
        self.usb_ports.setObjectName("usb_ports")
        self.port_refresh = QtWidgets.QPushButton(self.centralwidget)
        self.port_refresh.setGeometry(QtCore.QRect(260, 200, 201, 23))
